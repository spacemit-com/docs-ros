...
- Other RISC-V64 Linux distros (Fedora, openEuler RISC-V, Arch RISC-V, etc.)
...
This example uses the `lgpio` C library for GPIO operations. For more details, refere to the [Official documentation](https://abyz.me.uk/lg/lgpio.html)
