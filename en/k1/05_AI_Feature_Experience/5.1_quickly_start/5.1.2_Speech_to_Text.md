---
sidebar_position: 2
slug: /05_AI_Feature_Experience/5.1_quickly_start/5.1.2_Speech_to_Text
---
...
| -------------- | ---------------------- | ------------------------------------------------------------ |
| `sld`          | Silence Duration Threshold (seconds) | Speech ends if silence lasts ≥ `sld` seconds; <br />- Set to `0` to disable |
