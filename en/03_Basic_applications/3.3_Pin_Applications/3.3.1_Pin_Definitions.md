...
Bianbu Robot supports several types of main control boards. All boards provide standardized pin interfaces, making it easy to connect peripherals and expand functionality. This section summarizes the pin definitions for each supported board.
