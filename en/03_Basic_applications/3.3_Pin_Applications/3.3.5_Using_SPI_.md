...
Refer to the [Pin Definition Description](https://bianbu.spacemit.com/en/brdk/Basic_applications/3.3_Pin_Applications/3.3.1_Pin_Definitions) for available SPI pins on your board.
...
- **Cross-compile on the host:**
   ...
   For tool installation and usage, please refer to [Cross-Compilation Toolchain](https://developer.spacemit.com/documentation?token=BZfYwFfEmiSr7dkintEca9ERn3b)
