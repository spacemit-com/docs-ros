...
**Note:** When building OpenCV, make sure to enable the **WITH_GSTREAMER** option.
...
- Capture images at specified resolution, and use code to separate left/right images into respective folders (`left` and `right`)
