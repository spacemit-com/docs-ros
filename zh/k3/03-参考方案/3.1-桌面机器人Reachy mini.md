...
```bash
# 安装音频系统依赖（test_dance 和 reachy_voice_bot 需要）
sudo apt install  libsndfile1-dev libsamplerate0-dev libfftw3-dev
...
1. **连接硬件**
   ...
   ls /dev/tty*
    ...
    /dev/tty    /dev/tty16  /dev/tty24  /dev/tty32  /dev/tty40  /dev/tty49  /dev/tty57  /dev/tty8     /dev/ttyS14  /dev/ttyS8
    /dev/tty0   /dev/tty17  /dev/tty25  /dev/tty33  /dev/tty41  /dev/tty5   /dev/tty58  /dev/tty9     /dev/ttyS15  /dev/ttyS9
    /dev/tty1   /dev/tty18  /dev/tty26  /dev/tty34  /dev/tty42  /dev/tty50  /dev/tty59  /dev/ttyACM0  /dev/ttyS16
    /dev/tty10  /dev/tty19  /dev/tty27  /dev/tty35  /dev/tty43  /dev/tty51  /dev/tty6   /dev/ttyS0    /dev/ttyS2
    /dev/tty11  /dev/tty2   /dev/tty28  /dev/tty36  /dev/tty44  /dev/tty52  /dev/tty60  /dev/ttyS1    /dev/ttyS3
    /dev/tty12  /dev/tty20  /dev/tty29  /dev/tty37  /dev/tty45  /dev/tty53  /dev/tty61  /dev/ttyS10   /dev/ttyS4
    /dev/tty13  /dev/tty21  /dev/tty3   /dev/tty38  /dev/tty46  /dev/tty54  /dev/tty62  /dev/ttyS11   /dev/ttyS5
    /dev/tty14  /dev/tty22  /dev/tty30  /dev/tty39  /dev/tty47  /dev/tty55  /dev/tty63  /dev/ttyS12   /dev/ttyS6
    /dev/tty15  /dev/tty23  /dev/tty31  /dev/tty4   /dev/tty48  /dev/tty56  /dev/tty7   /dev/ttyS13   /dev/ttyS7
...
2. **准备配置文件**
   - 使用 `config.yaml` 配置模型路径和跟随参数

3. **启动人脸/手势跟随**
   ```bash
   face_tracker yolov5-face.yaml --control --camera-id 0 --port /dev/ttyACM0
   ```

   ```
   gesture_tracker yolov5_gesture.yaml --control --camera-id 0 --port /dev/ttyACM0
   # 当前支持跟随手势 - 手掌
   ```
