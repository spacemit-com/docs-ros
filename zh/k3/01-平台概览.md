...
- **想按能力/模块查资料** ：从专题域进入  
  - [04-AI与算法](04-AI与算法/index.md)（语音/视觉/LLM/VLM/Agent）  
...
- **核心功能套件层**：视觉/语音/LLM/VLM/Agent 等 AI 组件能力（见 [04-AI与算法](04-AI与算法/index.md)），系统服务、外设驱动与多媒体等平台能力（见 [06-系统与平台](06-系统与平台/index.md)）。
...
欢迎常来 [SpacemiT Robot GitHub](https://github.com/spacemit-robotics) 逛逛。进到组织主页后，记得点右上角的 **Follow**，先把社区入口收好；看到感兴趣的子仓库，也欢迎顺手点个 **Star**，方便以后回头找。跑起来遇到问题、踩到坑，或者有新想法，直接在对应仓库提 **Issue**，我们会及时跟进并反馈处理结果。
