...
- 组合应用：端到端语音对话见 [4.5 Agent](../4.5-Agent.md)，其中串联了 VAD、ASR、LLM、TTS、声纹和 MCP 工具调用。
- 仓库路径：
...
| 3 | [4.1.1 ASR](4.1.1-ASR.md) | 使用 SenseVoice、Zipformer、Qwen3-ASR 或 Fun-ASR Nano 将语音转成文本；流式能力取决于具体后端。 |
