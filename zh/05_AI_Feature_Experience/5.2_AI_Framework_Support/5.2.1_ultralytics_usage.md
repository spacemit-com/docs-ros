...
请浏览 **[Ultralytics 官网](https://www.ultralytics.com/)** 获取更多详情。
...
`Ultralytics` 使用 `PyTorch` 作为其后端框架，目前在 `SpacemiT RISC-V` 上 `PyTorch`暂未接入硬件加速，因此你可以在我们平台上使用 `Ultralytics`快速验证算法，当你部署时，请使用 `spacemit-ort` 框架以获得硬件加速，具体请参考 [Demo Zoo](https://gitee.com/bianbu/spacemit-demo) 和 [模型量化](/zh/07_Advanced_development/7.1_Model_Quantization.md)
