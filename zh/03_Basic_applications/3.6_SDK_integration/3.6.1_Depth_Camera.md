...
首先需要安装 **GStreamer**，安装步骤请参考：[GStreamer 使用指南](https://www.spacemit.com/community/document/info?lang=zh&nodepath=software/SDK/buildroot/media/gstreamer_user_guide.md)
