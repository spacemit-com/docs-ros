...
请参考[《引脚定义说明》](3.3.1_Pin_Definitions.md)，确认开发板支持的 SPI 引脚。
...
- **在主机上交叉编译此文件**
   ...
   编译工具下载及使用方法见[交叉编译工具手册](https://www.spacemit.com/community/document/info?lang=zh&nodepath=tools/user_guide/cross_compiler_user_guide.md)
